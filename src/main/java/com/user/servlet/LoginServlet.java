 ...
 //            log(us.toString());
             ...
             if(us != null){
                 ...
                 if(us.getRole().equalsIgnoreCase("admin")){
                     out.println("success=true" + us.toString());
                 ...
                 else if (us.getRole().equalsIgnoreCase("manager")) {
                     out.println("success=true" + us.toString());
                     response.sendRedirect("manager/home.jsp");
                 }
                 else{
                     sesion.setAttribute("failedMsg", "Email & Pasowrd Invalid");
                     out.println("success=false;" + us.toString());
                     response.sendRedirect("login.jsp");
                 }
             }else{
                 out.println("success=false." + " User is null");
                 sesion.setAttribute("failedMsg", "Email & Pasowrd Invalid");
                 response.sendRedirect("login.jsp");
             }
